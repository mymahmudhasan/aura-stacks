...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "AuraTrad.Ai — AI Crypto Trading, Mining & Staking Platform" },
        ...
        <div className="relative mx-auto max-w-7xl px-5 pt-10 md:pt-14 pb-16 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-6 text-base md:text-lg text-muted-foreground max-w-xl">
              AuraTrad.Ai's neural trading engine scans 300+ Binance pairs every second and only takes high-probability setups — with hard stop-loss, drawdown caps and capital-protection rules baked in. Your funds stay yours.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative">
              <img src={heroImg} alt="AuraTrad.Ai AI trading bot avatar" width={1024} height={1024} className="w-full h-auto drop-shadow-[0_30px_60px_rgba(56,189,248,0.35)]" />
        ...
        <div className="relative overflow-hidden rounded-3xl glass-strong p-10 md:p-16 text-center glow-primary">
          ...
          <div className="relative">
            ...
            <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
              Join 240,000+ Binance users earning passive income with AuraTrad.Ai's neural trading engine.
            </p>
...
const features = [
  ...
  { icon: <Users />, title: "Referral Rewards", desc: "Earn lifetime commissions across 3 levels by inviting friends to AuraTrad.Ai." },
