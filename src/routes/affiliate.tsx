...
export const Route = createFileRoute("/affiliate")({
  ...
  head: () => ({
    meta: [
      { title: "Affiliate & Referral Commissions — AuraTrad.Ai" },
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Every AuraTrad.Ai service has its own referral commission. Share, refer, and earn lifetime crypto rewards paid daily to your Binance wallet."
      />
      ...
      <Section eyebrow="How it works" title={<>Three steps to <span className="gradient-text">passive crypto income</span></>}>
        <div className="grid md:grid-cols-3 gap-5">
          {[
            { i: <Share2 />, t: "1. Share your link", d: "Get a unique referral link for each AuraTrad.Ai service from your dashboard." },
