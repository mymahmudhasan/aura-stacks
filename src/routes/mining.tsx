      ...
      <Section>
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-muted-foreground">NovaVault operates next-generation mining facilities optimized for performance, cooling and renewable energy. Your investment powers real hashrate.</p>
